  ...
  const steps = [
    {
      ...
      text: "Я ваш гид Фини. Покажу, как устроен интерактивный конкурсный прототип и где искать данные о бюджете Москвы. Баллы здесь учебные: они помогают отмечать прогресс и не обмениваются на городские призы.",
      targetSelector: null,
      mood: "waving" as const,
    },
    {
      title: "Ваш профиль и баланс баллов",
      text: "В шапке находится локальный демо-профиль. Уровень, опыт (XP) и учебные баллы сохраняются только в этом браузере; связи с Mos.ID и передачи персональных данных нет.",
      targetSelector: "#tour-header",
      mood: "neutral" as const,
    },
    {
      title: "Чекап профиля и выбор роли",
      text: "Выберите учебный сценарий: Студент, Молодой специалист, Предприниматель или Семья с детьми. Выбор меняет стартовый пример расходов в калькуляторе, а не определяет право на льготы.",
    ...
    },
    {
      ...
      text: "Выполняйте задания, проходите викторины по финансовой грамотности, играйте в симулятор районного бюджета и исследуйте карту Москвы. Достижения пополняют баланс учебных баллов.",
      targetSelector: "#tour-quests",
      mood: "neutral" as const,
    },
    {
      title: "Интерактивная аналитика бюджета",
      text: "Исследуйте округлённую структуру расходов Москвы на 2026 год. Режим модели вычета показывает пропорции для наглядности и не является расчётом вашего личного вклада или НДФЛ.",
      targetSelector: "#tour-analytics",
      mood: "thinking" as const,
    },
    {
      title: "Интерактивный бюджетный справочник",
      text: "Откройте справочник, чтобы получить ответ по заранее подготовленным темам или запустить экспресс-квиз. Это локальная база подсказок, а не официальный консультант и не генеративный ИИ.",
      targetSelector: "#tour-ai",
      mood: "waving" as const,
    },
    {
      title: "Вы готовы исследовать бюджет!",
      text: "Экскурсия завершена. Теперь можно изучать бюджетные показатели, проходить учебные квесты и сверяться со ссылками на официальные источники.",
      targetSelector: null,
      mood: "happy" as const,
    }
  ];

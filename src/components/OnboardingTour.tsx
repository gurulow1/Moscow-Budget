  ...
  const steps = [
    {
      ...
      text: "Я ваш гид Фини. Покажу, как устроен интерактивный учебный маршрут и где искать данные о бюджете Москвы. Баллы здесь учебные: они помогают отмечать прогресс и не обмениваются на городские призы.",
      targetSelector: null,
      mood: "waving" as const,
    },
    {
      title: "Ваш профиль и баланс баллов",
      text: "В шапке находится локальный профиль. Уровень, опыт (XP) и учебные баллы сохраняются только в этом браузере; связи с Mos.ID и передачи персональных данных нет.",

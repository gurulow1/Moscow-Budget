...
export default function CityRewardsHub({
  ...
  return (
    <>
      <section className="relative overflow-hidden rounded-[28px] border border-white/90 bg-[linear-gradient(135deg,rgba(234,249,246,0.96),rgba(255,255,255,0.78)_55%,rgba(238,244,255,0.88))] p-5 md:p-6 shadow-[0_18px_48px_rgba(15,23,42,0.07)]">
        ...
        <div className="relative grid gap-5 lg:grid-cols-[1.35fr_0.65fr] lg:items-stretch">
          <div>
            ...
            <div className="mt-5 flex flex-col sm:flex-row gap-2.5">
              ...
              <button
                ...
                className="rounded-full border border-[#0F9F91]/25 bg-white/70 px-5 py-3 text-sm font-black text-[#0B766E] transition hover:bg-white flex items-center justify-center gap-2"
              >
          ...
          <div className="grid grid-cols-2 gap-2.5">
            <div className="rounded-[22px] border border-white/90 bg-white/66 p-4 backdrop-blur-xl">
